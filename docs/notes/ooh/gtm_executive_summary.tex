...
\sect{Honest caveats}
OOH measurement is standards-driven, so an independent index has to be benchmarked before owners adopt it. Comfort-to-dwell is a hypothesis the first pilot exists to test. Mobile-location panels out-scale us, so the pitch stays on explanatory quality rather than raw coverage. All heat readings are surface temperature until street-level measurement exists.
